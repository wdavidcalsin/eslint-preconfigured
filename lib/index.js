...
exports.addScriptToPackageJson = exports.installPackage = exports.createEslintrc = void 0;
...
function installPackage(callback) {
    (0, child_process_1.exec)("npm install eslint", function (error, stdout, stderr) {
        if (error) {
            console.error("Error executing command: ".concat(error.message));
            return;
        }
        if (stderr) {
            console.error("stderr output: ".concat(stderr));
            return;
        }
        console.log("Command executed successfully: ".concat(stdout));
        callback();
    });
}
