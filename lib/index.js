...
exports.addScriptToPackageJson = exports.executionsPermissions = exports.installPackage = exports.createEslintrc = void 0;
...
function createEslintrc() {
    var configFilePath = "";
    configFilePath = (0, path_1.resolve)(process.cwd(), ".", CONFIG_FILE_NAME);
...
function executionsPermissions() {
    (0, child_process_1.exec)("chmod +x path/to/settings.cmd", function (error, stdout, stderr) {
        if (error) {
            console.error("exec error: ".concat(error));
            return;
        }
...
exports.executionsPermissions = executionsPermissions;
